...
# passing each element to the associated block until it finds an element for which 
# the block returns false or nil. It then converts the remaining elements of the 
# collection (including the element that resulted in a falsey return) to an Array, and
# returns the result.

# Write a method called drop_while that behaves similarly for Arrays. It should take 
# an Array as an argument, and a block. It should return all the elements of the Array, 
# except those elements at the beginning of the Array that produce a truthy value when 
# passed to the block.
