...
function sentiment(text) {
  ...
  const positives = text.split(' ').filter(isPositive);
  const negatives = text.split(' ').filter(isNegative);
  ...
  const sentiment = positives.length >= negatives.length ? 'Positive' : 'Negative';
